...
def determine_first_and_last_numbers_for_line(numbers_array):
    ...
    first_number = first_number_obj['value'] if str(first_number_obj['value']).isdigit(
    ) else convert_string_to_number(first_number_obj['value'])
    last_number = last_number_obj['value'] if str(last_number_obj['value']).isdigit(
    ) else convert_string_to_number(last_number_obj['value'])
